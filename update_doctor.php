...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.3.0/font/bootstrap-icons.css">
    <link rel="stylesheet" href="css/update_doctor.css">
    <style>
        .login{
...
<button class="login"><a href="login.php"><i class="bi bi-box-arrow-left"></i>  LogOut</a></button>
        ...
        <div class="row tables">
            ...
            <?php  
                ...
                $result = mysqli_query($conn,$sql) or die("Somethink went wrong");
            ...
            <div class="col-md-8 tableform">
                <form action="update_D_conn.php" method="post">
                  
                      <label for="doctor_name">Doctor Name:</label>
                      <input type="hidden" name="id" value="<?php echo $row['id'] ?>">
                      <input type="text" id="doctor_name" name="name" required placeholder="Enter Here..." value="<?php echo $row['name'] ?>"><br>
                     
                      <label for="experience">Experience (in years):</label>
                      <input type="number" id="experience" name="experience" required placeholder="Enter Here..." value="<?php echo $row['experiance'] ?>"><br>

                      <label for="phone">Phone:</label>
                      <input type="tel" id="phone" name="phone" required placeholder="Enter Here..." value="<?php echo $row['phone'] ?>"><br>

                      <label for="specialization">Specialization:</label>
                      <select id="special" name="special" required placeholder="Enter Here..." value="<?php echo $row['special'] ?>">
                      ...
                      <select id="availability" name="availability" required placeholder="Enter Here..." value="<?php echo $row['availability'] ?>">
                        <option value="">Select</option>
                      ...
                      <select id="gender" name="gender" required placeholder="Enter Here..." value="<?php echo $row['gender'] ?>">
                        <option value="">Select</option>
