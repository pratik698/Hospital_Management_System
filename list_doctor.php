<?php
        ...
        $id=$_POST['search'];
        $query="SELECT * FROM doctor WHERE CONCAT(name,phone) LIKE '%$id%'";
...
<button class="login"><a href="login.php"><i class="bi bi-box-arrow-left"></i>  LogOut</a></button>
        ...
        <div class="row">
            <div class="col-md-12">
                <h3 style="margin-top: 40px; color:#138D75;">List Of Doctor</h3>
              <nav class="navbar navbar-light bg-white" id="navb" style="margin-top: 30px;">
                <form class="form-inline" action="list_doctor.php" method="POST">
    ...
    <table class="table" cellpadding="7px">
        ...
        foreach($data as $row )
        {
            ...
            <tr>
                ...
                <td>
                    <a href='update_doctor.php?id=<?php echo $row['id'] ?>' class="update">Update</a>
                    <a href='delete_doctor.php?id=<?php echo $row['id'] ?>' class="delete">Delete</a>
                </td>
            </tr>
