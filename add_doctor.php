...
form{ 
    ...
    width: 600px;
    margin-left: 50px;
    background-image: url('http://localhost/Mico%20Free%20Website%20Template%20-%20Free-CSS.com/Mico%20Free%20Website%20Template%20-%20Free-CSS.com/mico-html/images/post3.jpg');
    ...
    <div class="row drop">
        ...
        <div class="row tables">
            ...
            <div class="col-md-8 tableform">
                <form action="add_D_conn.php" method="post">
                  
                      <label for="doctor_name">Doctor Name:</label>
                      <input type="text" id="doctor_name" name="name" required placeholder="Enter Here..." value="Dr."><br>
                     
                      <label for="experience">Experience (in years):</label>
                      <input type="number" id="experience" name="experience" required placeholder="Enter Here..."><br>

                      <label for="phone">Phone:</label>
                      <input type="number" id="phone" name="phone" pattern="[0-9]{10} "required placeholder="Enter Here..."><br>

                      <label for="specialization">Specialization:</label>
                      <select id="special" name="special" required placeholder="Enter Here...">
                      ...
                      <select id="availability" name="availability" required placeholder="Enter Here...">
                        <option value="">Select</option>
