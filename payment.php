    ...
    <div class="container">
        ...
        <div class="row drop " style="margin-left:-10px;">
            ...
            <div class="col-md-2">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                        <li><a class="dropdown-item" href="payment.php"><i class="bi bi-credit-card-2-back"></i>Payment</a></li>
                        <!-- <li><a class="dropdown-item" href="all_payment.php"><i class="bi bi-wallet-fill"></i>All Payments</a></li> -->
                    </ul>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="form-group">
                ...
                <input type="text" id="pname" name="pname" class="form-control" required value="<?php echo $row['pname']; ?>">
                
            </div>
            <div class="form-group">
                <label for="dname">Name of Doctor:</label>
                <input type="text" id="dname" name="dname" class="form-control" required value="<?php echo $row['dname']; ?>">
            </div>
         ...
         ?>
            ...
            <div class="form-group">
                ...
                <input type="text" id="fee" name="fee" class="form-control" value="300" readonly>
            </div>
            <div class="form-group">
                <label for="facility">Other Facility:</label>
                <select id="facility" name="facility" class="form-control">
                    <option value="0">Select a facility</option>
                    <option value="100">X-ray (100 RS)</option>
                    <option value="200">MRI (200 RS)</option>
                    <option value="50">Blood Test (50 RS)</option>
                </select>
            </div>
            <div class="form-group">
            ...
            <div class="subb">
            <a href="list_appointment.php">Pay</a>
            </div>
        </form>
