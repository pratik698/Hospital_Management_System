...
<button class="login"><a href="login.php"><i class="bi bi-box-arrow-left"></i>  LogOut</a></button>
        ...
        ?>
            ...
            <div class="col-md-8 tableform">
                <form action="update_P_conn.php" method="post">
                      ...
                      <input type="number" id="age" name="age" required placeholder="Enter Here..." value="<?php echo $row['age']; ?>"><br>

                      <label for="dob">Date of Birth:</label>
                      <input type="date" id="dob" name="dob" required placeholder="Enter Here..." value="<?php echo $row['dob']; ?>"><br>

                      <label for="phone">Phone:</label>
                      <input type="tel" id="phone" name="phone" required placeholder="Enter Here..." value="<?php echo $row['phone']; ?>"><br>

                      <label for="email">Email:</label>
                      <input type="email" id="email" name="email" required placeholder="Enter Here..." value="<?php echo $row['email']; ?>"><br>
