<?php
    ...
    $id=$_POST['search'];
    $query="SELECT * FROM patient WHERE CONCAT(name,phone) LIKE '%$id%'";
...
<button class="login"><a href="login.php"><i class="bi bi-box-arrow-left"></i>  LogOut</a></button>
        ...
        <div class="row">
            <div class="col-md-12">
              ...
              <nav class="navbar navbar-light bg-white" id="navb" style="margin-top: 30px;">
                <form class="form-inline" action="list_patient.php" method="POST">
        ...
        <div class="row">
            ...
            <tr>
                ...
                <td>
                    <a href='update_patient.php?id=<?php echo $row['id'] ?>' class="update">Update</a>
                    <a href='delete_patient.php?id=<?php echo $row['id'] ?>' class="delete">Delete</a>
                </td>
                <td><a href='appointment.php?id=<?php echo $row['id'] ?>' class="appo">Appointment</a></td>
            </tr>
